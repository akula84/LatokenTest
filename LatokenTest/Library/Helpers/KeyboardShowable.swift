 ...
 */
public extension KeyboardShowable
{
    /// переменная высоты нижнего констрейнта
    ...
    func addKeyboardObservers() {
        ...
        removeObserver = addObserverForName(classNotification) { [weak self] (notification) in
            ...
            defaultCenter.removeObserver(keyboardShow, name: UIResponder.keyboardWillShowNotification, object: nil)
            
            defaultCenter.removeObserver(keyboardHide, name: UIResponder.keyboardWillHideNotification, object: nil)
